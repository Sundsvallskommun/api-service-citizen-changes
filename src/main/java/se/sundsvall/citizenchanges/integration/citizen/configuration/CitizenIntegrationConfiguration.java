...
public class CitizenIntegrationConfiguration {
	...
	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final CitizenIntegrationProperties citizenIntegrationProperties, final ClientRegistrationRepository clientRepository) {
