...
public class ReminderResource {
	...
	public ResponseEntity<BatchStatus> runReminderBatch(
		...
		final var thisResponse = reminderService.runBatch(firstErrand, numOfErrands, sendMessage);
	...
	public ResponseEntity<BatchStatus> runReminderBatch(
		...
		@RequestParam("sendMessage") final boolean sendMessage) {
		final var thisResponse = reminderService.runBatch(0, 0, sendMessage, oepErrands, null, null);
		return ResponseEntity.ok(thisResponse);
	}
	...
	public ResponseEntity<BatchStatus> runReminderBatch(
		...
		final var thisResponse = reminderService.runBatch(firstErrand, numOfErrands, sms, email);
		return ResponseEntity.ok(thisResponse);
	}
